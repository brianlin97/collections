...
var count;
var audioSound = document.getElementsByClassName('audio-duomo');
var audiosrc;
console.log(document.getElementsByClassName('active').length);

// for(i=0; i < audioSound.length; i++){
	// var audio = document.getElementsByClassName('audio-duomo')[0];
	var audio = document.getElementsByClassName('active')[1];

	// audio.src = "http://localhost:8888/collections/audio-logs/duomo/Duomo%208PM%201.m4a";
