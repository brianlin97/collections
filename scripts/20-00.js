...
function draw() {
	...
	// background
	var my_gradient= canvasCtx.createLinearGradient(canvas.width/90, 0, canvas.width, canvas.height);
	my_gradient.addColorStop(0,"rgb(255,106,0)");
	my_gradient.addColorStop(1,"rgb(238,9,121)");
